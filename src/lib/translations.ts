...
export const translations = {
    id: {
      ...
      hero: {
        title: "Buka Potensi Bahasa Inggrismu",
        subtitle: "Belajar langsung dari tutor berpengalaman dengan jadwal fleksibel. Tingkatkan kepercayaan dirimu dalam berbahasa Inggris, mulai hari ini!",
        cta: {
    ...
    en: {
      ...
      hero: {
        ...
        subtitle: "Learn directly from experienced tutors with a flexible schedule. Boost your confidence in speaking English, starting today!",
        cta: {
