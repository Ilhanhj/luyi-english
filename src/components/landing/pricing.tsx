...
function PricingCard({ pkg }: { pkg: ReturnType<typeof getPricingPackages>[0] }) {
  return (
    <div
      className={cn(
        "glass-card flex flex-col h-full rounded-3xl overflow-hidden transition-all duration-300 relative",
        pkg.isPopular
    ...
    >
        {pkg.badgeText && (
          <Badge
            className={cn(
              "absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2 border-0 shadow-md text-sm py-1 px-4",
              pkg.isPopular
    ...
    <section id="pricing" className="py-16 md:py-24 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 md:px-6 relative">
        ...
        <div data-aos="fade-up" data-aos-delay="200">
          ...
          <div className="hidden lg:grid grid-cols-1 md:grid-cols-2 gap-8 mt-8 max-w-4xl mx-auto">
