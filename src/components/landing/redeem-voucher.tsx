      ...
      <div className="max-w-4xl mx-auto">
        <div className="relative overflow-hidden rounded-[2.5rem] bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 border border-white/10 shadow-2xl p-8 md:p-12 text-center">
          ...
          <div className="relative z-10 flex flex-col items-center">
            ...
            <h2 className="text-3xl md:text-4xl font-extrabold text-white mb-4">Punya Kode Promo?</h2>
            <p className="text-slate-400 mb-8 max-w-lg mx-auto">Masukkan kode voucher rahasia yang kamu temukan di Instagram atau TikTok kami untuk mendapatkan potongan harga spesial!</p>
            ...
            <div className="flex flex-col sm:flex-row gap-3 w-full max-w-md mx-auto relative">
              ...
              <Button
                ...
                className={cn("h-14 px-8 rounded-xl font-bold text-lg transition-all shadow-lg", status === "success" ? "bg-emerald-500 hover:bg-emerald-600 text-white" : "bg-amber-400 hover:bg-amber-500 text-slate-900")}
              >
                {status === "loading" ? <Loader2 className="w-5 h-5 animate-spin" /> : status === "success" ? "Berhasil!" : "Cek Kode"}
              </Button>
            </div>
            ...
            {status === "success" && result && (
              <div className="mt-8 w-full max-w-lg animate-in zoom-in duration-500">
                  ...
                  <div className="flex items-center justify-between relative z-10">
                    ...
                    <div className="text-right">
                      <Button asChild size="sm" className="bg-emerald-500 hover:bg-emerald-600 text-white rounded-full">
                        <a href={`https://wa.me/+6289526437454?text=Halo%20Admin,%20saya%20mau%20klaim%20promo%20kode%20*${code.toUpperCase()}*%20untuk%20dapat%20diskon%20${result.discount}`} target="_blank">
                          Klaim Sekarang
                        </a>
                      </Button>
                    </div>
                ...
                <p className="text-slate-500 text-xs mt-3">*Klik tombol "Klaim Sekarang" untuk terhubung ke WhatsApp Admin</p>
              </div>
            )}
          </div>
        </div>
